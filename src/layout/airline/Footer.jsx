...
const Footer = () => {
  return (
    <div className="absolute bottom-0 fixed left-0 right-0 px-5 xl:px-15 bg-transparent">
      <div className="flex flex-col lg:flex-row justify-start items-start border-t-0.5 border-opacity-30 p-5 lg:py-10 xl:p-15 lg:text-white text-gray-400 text-opacity-90">
        <Link to="/">{/* <img className="h-8 md:h-14" alt="logo" src={whiteLogo}/> */}</Link>
        <div className="flex flex-1 lg:justify-end 3xl:justify-start 3xl:ml-120 flex-wrap sm:flex-nowrap text-xs md:text-sm lg:text-base">
          <div className="grid grid-cols-7 space-x-2">
            <ul className="uppercase xl:px-15 py-5 lg:py-0 space-y-3 col-span-3">
              ...
              <li>
                <Link to="/news?selectedTab=career">career</Link>
              </li>
            </ul>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center text-gray-400 md:text-white uppercase text-xs p-5 xl:px-15 py-8 font-montserrat tracking-wide border-t-0.5 border-opacity-30 leading-7">
        <div className="flex flex-1 flex-col lg:flex-row justify-center">
          <a
            href="tel:+355697047231"
            className="flex flex-row lg:flex-col xl:flex-row items-center">
          ...
          <li className="flex flex-row lg:flex-col xl:flex-row flex-wrap items-center lg:mx-10">
            <span className="mr-3">Address:</span> Rr. Frank Bardhi, Tiranë, Albania, Kristal
            Center, Kati 2
          </li>
